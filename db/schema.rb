...
ActiveRecord::Schema.define(version: 20160430235040) do
  ...
  add_index "comments", ["labelable_type", "labelable_id"], name: "index_comments_on_labelable_type_and_labelable_id"
